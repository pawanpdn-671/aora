...
const Create = () => {
	...
	const handleSubmit = async () => {
		if (!formData.prompt || !formData.title || !formData.video || !formData.thumbnail) {
		...
		<SafeAreaView className="bg-primary h-full">
			<ScrollView className="px-4 my-6">
				...
				<FormField
					...
					handleChange={(e) => setFormData({ ...formData, title: e })}
					otherStyles={"mt-10"}
				/>
				...
				<FormField
					...
					handleChange={(e) => setFormData({ ...formData, prompt: e })}
					otherStyles={"mt-7"}
				/>
